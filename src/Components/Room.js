            ...
            <div className="container">									
                ...
                <form onSubmit={this.handleSubmit}>									
                    ...
                    <div className="btt-add">                                     
                        <button type="submit" id="add" onClick={this.saveLocalStorage} className="btn btn-primary">Add</button>									
                        <button type="submit" id="add" onClick={this.handleMessage} className="btn btn-primary">Dat Phong</button>
                    </div>  
            ...
            <table className="table table-striped table-dark">									
                ...
                <tbody>									
                    ...
                    <tr>									
                        ...
                        <td><img src={item.myfile} style={{ width:'50px', height:'50px' }}/></td>									
                        <td>{item.area}</td>									
                        <td>{item.price}</td>									
                        <td>{item.oldprice}</td>									
                    </tr>									
